...
export default function AdminDoctorsPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Manage your clinic's dental specialists and their profiles.
          </p>
        </div>

        <button
          onClick={handleAdd}
          className="inline-flex min-h-11 items-center justify-center gap-2 rounded-xl bg-green-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm shadow-green-500/20 transition-all duration-200 hover:bg-green-700 hover:shadow-md active:scale-95"
        >
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-gray-500 font-medium">Total Doctors</div>
            </div>
          </div>
        </div>
      ...
      {/* ============ TOOLBAR ============ */}
      <div className="rounded-2xl border border-gray-100 bg-white shadow-sm p-4 mb-6 space-y-3">
              ...
              <div className="p-4">
                ...
                <div className="mt-3 pt-3 border-t border-gray-100 flex items-center justify-between text-xs text-gray-500">
                  <span className="inline-flex items-center gap-1">
                    ...
                    {doctor.experienceYears || 0}y exp
                  </span>
            ...
            <table className="w-full">
              <thead className="bg-gray-50/80 border-b border-gray-100">
                <tr>
                  ...
                  <th className="text-left px-6 py-3 text-[10px] font-bold text-gray-500 uppercase tracking-wider hidden md:table-cell">
                    Schedule
                  </th>
                  <th className="text-left px-6 py-3 text-[10px] font-bold text-gray-500 uppercase tracking-wider">
                    Status
